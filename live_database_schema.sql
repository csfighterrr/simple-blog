-- Live Database Schema from Supabase (Extracted on October 2, 2025)
-- This is the actual schema currently running in production
...
-- IMPORTANT: This is the key fix - posts.author_id now references profiles.id instead of auth.users.id
ALTER TABLE ONLY "public"."posts"
